...
\thanks{This publication is part of the project DIGITAL TWIN (with project number P18-03) of the research programme TTW Perspective which is (partly) financed by the Dutch Research Council (NWO). This work was supported by funding from the topic Engineering Secure Systems of the Helmholtz Association (HGF) and by KASTEL Security Research Labs. This work was supported by "Kerninformatik am KIT (KiKIT)" funded by the Helmholtz Association (HGF).}
}


\author{
\IEEEauthorblockN{Hossain Muhammad Muctadir\IEEEauthorrefmark{1}\orcidlink{
0000-0002-2090-4766}, Lars König\IEEEauthorrefmark{2}\orcidlink{0000-0002-1751-1291}, Thomas Weber\IEEEauthorrefmark{2}\orcidlink{0009-0001-5775-2225}, Moussa Amrani\IEEEauthorrefmark{3}\orcidlink{0000-0002-6987-1037}, Loek Cleophas\IEEEauthorrefmark{1}\textsuperscript{,}\IEEEauthorrefmark{4}\orcidlink{0000-0002-7221-3676}}
...
\IEEEauthorblockA{\IEEEauthorrefmark{4}\textit{Department of Information Science},
...
% \TW{Changed the comma from author affiliation from Loek from , to \textsuperscript{,}}
\input{chapters/Introduction}
\input{chapters/Background}
\input{chapters/Example}
\input{chapters/ConceptualModel}
\input{chapters/Approach}
% \input{chapters/Formalization}
\input{chapters/RW}
\input{chapters/Discussion}
\input{chapters/Conclusion}
% \LC{TODO for References: add DOIs where available; consistify}\HM{done}
