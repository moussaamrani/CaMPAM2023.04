...
Rename  &  Old name $s$ is referred in the \viewtype \LK{with identity we do not have to match names, right?}  &  $UP$dating $s$ with $s_c$ where $s_c$ is the current name & M \\ \hline
