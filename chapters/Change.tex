...
\begin{figure}[t]
    ...
    \caption{A \textsf{Suggestion} holds for a single \textsf{Change} linked to 
		elements in a View Type through \textsf{Relation}s, and consists of a set of \textsf{Recommendation}s \HM{add condition element?}.}
...
\LC{TODO Hossain adjust b/o table changes to be made} \HM{moved ignore list to Sec.\ref{sec:Approach}}
