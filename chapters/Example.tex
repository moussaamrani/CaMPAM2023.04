...
but \viewtypes likely have \HM{is this a "need" or a possibility?}\MA{Rephrased differently!}
to reflect this new information by \emph{ADD}ing new entities in appropriate places.
...
\HM{I think it might be useful to mention the operators from Table \ref{tab:suggestions} applied to the MM at each step and later connect this with the suggestions?}
