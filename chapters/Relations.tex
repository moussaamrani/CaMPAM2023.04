...
\begin{itemize}
	...
	$\mathsf{<} \mathsf{State \squaredots kind} ; \mathsf{Regular} \mathsf{>}$.\LC{Also one for Final states?}
	...
	$\mathsf{<} \mathsf{Kind \squaredots INITIAL} ; \mathsf{Initial} \mathsf{>}$.\LC{Again, for FINAL too?}
