...
With an essential SUM \MA{Abbreviation never introduced before} there is a single model, which contains the complete system description and is free of any internal redundancies \autocite{atkinson_orthographic_2010}.
