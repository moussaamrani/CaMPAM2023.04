...
types, which jointly can completely cover any evolution process, and 
\emph{complex} changes, which consist of a coherent list of interrelated atomic changes about which one has additional semantic knowledge.
...
meaningful evolution steps on which further analyses and automated co-evolution support can be built.
