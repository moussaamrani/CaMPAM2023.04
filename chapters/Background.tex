...
\LK{As discussed, we might not need to focus on a specific language if we differentiate only between ``used in the VT'' and ``used in the VGT''.}
% TODO may need further justification if we keep this
